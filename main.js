        ...
        if(!turn.classList.contains("moving")) {
            ...
            if(turn.classList.contains("player1")) {
                ...
                if(this.classList.contains("p1")) {
                    ...
                    statusText.innerHTML = "Ny Fotsy no mandeha!";
                }
                ...
                if(this.classList.contains("p2")) {
                    ...
                    statusText.innerHTML = "Ny Mainty no mandeha!";
                }
            ...
            if(turn.classList.contains("player1")) {
                ...
                if(this != temp) {
                    ...
                    statusText.innerHTML = "Ny Mainty no mandeha!";
                        ...
                        statusText.innerHTML = "Diso Famindra!";
                    }

                    if(gameOver(1)){
                        statusText.innerHTML = "Mandresy ny Fotsy!";
                        alert("Mandresy ny Fotsy");
                ...
                if(this != temp) {
                    ...
                    if(gameOver(2)){
                        statusText.innerHTML = "Mandresy ny Mainty!";
                        alert("Mandresy ny Mainty!");
                        window.location.reload();
                    }
